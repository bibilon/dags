...
with DAG(
   ...
   start >> wait_for_load_RP_SUB_PRE_dags >> t2 >> spark_sensor_2 >> push_sensor_2_status >> branch_task_2 >> delete_task_2 >> t3 >> spark_sensor_3 >> push_sensor_3_status >> branch_task_3 >> delete_task_3 >> end
